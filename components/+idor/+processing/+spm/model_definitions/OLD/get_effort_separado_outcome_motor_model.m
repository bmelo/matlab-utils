...
% pres_codes
function model = get_effort_separado_outcome_motor_model()

    categories = { 'rewardFLA', 'rewardSTI' ,'rewardSELF', 'rewardEFFORTONLYFLA', 'rewardEFFORTONLYSTI', 'rewardEFFORTONLYSELF', 'rewardCUEONLY_FLA', 'rewardCUEONLY_STI', 'rewardCUEONLY_SELF', 'ClipFla.*', 'ClipAvai.*' };
    spm_names  = { 'OUTCOME TEAM', 'OUTCOME STI' ,'OUTCOME SELF', 'OUTCOME EFFORT TEAM', 'OUTCOME EFFORT STI','OUTCOME EFFORT SELF','OUTCOME CUEONLY TEAM', 'OUTCOME CUEONLY STI', 'OUTCOME CUEONLY SELF',  'CLIP TEAM', 'CLIP AVAI' };
    ...
    model.name = 'EFFORT_SEP_OUTCOME_MOTOR';
    model.def  = def;
