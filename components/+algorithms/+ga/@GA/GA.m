classdef GA < utils.Generic
    ...
    methods
        function obj=GA( sujeitos, areas, atlas )
            ...
            %Calcula o n�mero m�ximo de elementos
            if(length(areas)<50)
        ...
        function report(obj)
            ...
            if(exist('temp_data.mat', 'file'))
                movefile('temp_data.mat', [datestr(obj.finishTime,30) '.mat']); %Salva dados tempor�rios para poder recuperar processamento
            end
        end
    ...
    methods(Access = private)    
        ...
        %Realiza os cruzamentos e muta��es
        function reproduction(obj)
            obj.populacao{end+1} = {}; %Todos os filhos far�o parte da nova gera��o
            ...
            obj.mutacao(); %Faz a muta��o nos indiv�duos novos
