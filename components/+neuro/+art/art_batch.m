...
%% code thresholds in output directories
for k=1:length(outputdirs)
    outputdirs{k} = [outputdirs{k} '_' num2str(motion_threshold) '_' num2str(global_threshold)];
end
