function resizephotos(directory, wh, isrecursive, isoverwrite, savetopath, supportFormat, quality)
...
% 
% Example:
%           resizephotos('.', [1920, 1920], true, false, 'output\', '*', 85)
%
...
if iscell(directory)
    for i = 1:numel(directory)
        resizephotos(directory{i}, wh, isrecursive, isoverwrite, savetopath, supportFormat, quality);
    end
    return;
end
