function onsets = determinarOnsetsCE(condition, log, CEs, varargin)
...
switch(condition)
    ...
    case 'RIGHT HAND'
        ...
        onsets = double( log{cPuls}(posicoes)-1 );
        delays = double( log{cDelay}(posicoes) * .001 );
    %% Mão esquerda 
    case 'LEFT HAND'
