classdef PRJ1008_ALPHA < handle & ProjectSPM
    properties
        %Atributos específicos do projeto
    end
    
    methods (Access = public)
        function obj=PRJ1008_ALPHA()
            %Config
            obj.code = 'PRJ1008_ALPHA';
            obj.description = 'Projeto Blindness';
            
            %Input        
            obj.baseDir = 'C:\Documents and Settings\sebastian\Desktop\PRJ1008_ALPHA\';
            obj.rawDir = 'C:\Documents and Settings\sebastian\Desktop\PRJ1008_ALPHA\RAW_DATA';
            obj.subjects = 8; %Identificador dos sujeitos que serão analisados
