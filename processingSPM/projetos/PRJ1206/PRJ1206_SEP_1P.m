classdef PRJ1206_SEP_1P < handle & ProjectSPM & PRJ1206
    properties
        %Atributos específicos do projeto
    end
    
    methods (Access = public)
        function obj=PRJ1206_SEP_1P()
            ...
            obj.pathSessions = {'fMRI_IMAG_1P'};
            
            %Output
            obj.folderFL = 'STATS_1P';
            
            % Contrasts
            obj.contrastes = FirstLevel.importContrastsXls( '\\10.36.4.201\dados3\Users\sebastian\My Documents\MATLAB\processingSPM\docs\PRJ1206_1P.xlsx' );
    ...
    methods (Access = protected)
        ...
        function ajustaConditions(obj)
                obj.conditions.sess(1).cond(1).name = '1P';
