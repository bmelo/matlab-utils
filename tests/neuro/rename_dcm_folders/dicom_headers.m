function hdr = dicom_headers(P, essentials)
...
dict = readdict;
%Inserindo elemento que estava causando problema! - bruno
dict.element(end+1) = 37010;
dict.group(end+1) = 8;
dict.values(end+1) = struct('name','Private_0008_2029', 'vr', {{'SQ'}}, 'vm', '1');
j    = 0;
hdr  = {};
